...
tables_coast = store[goods['Стол']][0]['price'] + store[goods['Стол']][1]['price']  # TODO цены не правильно складывать,
# стоимость считается немного по другому
tables_count = store[goods['Стол']][0]['quantity'] + store[goods['Стол']][1]['quantity']

print('Стол -', tables_count, 'шт, стоимость', tables_coast * tables_count, 'руб')
